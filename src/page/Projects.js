...
import img3 from '../assets/img/projects/exchang.webp';
    ...
    return (
        <div>
            <h1 style={{paddingBottom: 20, paddingTop: 30}}>Projects</h1>
                ...
                <Card className='p-3' style={{ backgroundColor: '#282c34' }} >
                        <CardImg src={img3} alt="" style={{width: 300, height: 300}}/>
                        <a style={{padding: 10, color: "white"}} href='https://main--effortless-tanuki-df551a.netlify.app/'>Exchange Rate --Live</a>
